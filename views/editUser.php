    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="" method="post" id="signupform">
            ...
            <div class="p-5 px-2 w-full flex gap-5">
                ...
                <a href="./home.php" type="submit" class="font-medium text-center w-full rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer bg-red-600 text-white hover:bg-gray-700 focus:ring-indigo-500 px-4 py-2 text-base">
                    Cancel
                </a>
            </div>
        </form>
