        ...
        <div class="flex h-screen bg-gray-100">
            ...
            <div class="flex flex-col h-screen w-64 bg-gray-900 text-white">
                ...
                <nav class="flex-1 px-2 py-4">
                    <ul>
                        <li class="flex cursor-pointer items-center w-full px-4 py-2 text-gray-300 rounded-lg hover:bg-gray-800 hover:text-white transition-colors"  >
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                <header class="bg-white border-b border-gray-200 h-16">
                    <div class="h-full px-4 flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="text-center font-bold text-xl flex justify-end">
                                <div class="flex font-normal text-sm gap-5 text-center">
                                    <form action="../controllers/logoutController.php" method="post">
                                        <button class="p-2 px-5 bg-gray-900 rounded-lg text-white" type="submit">Logout</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <div class="text-left p-10 px-10"> 
                    <div>
